    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            <div class="mt-6">
                ...
                <BreezeInput placeholder="Nome" id="name" type="text" class="mt-1 block w-full" v-model="form.name" required autofocus autocomplete="name" />
            </div>
        </div>
            ...
            <div class="mt-6">
                ...
                <BreezeInput placeholder="Senha" id="password" type="password" class="mt-1 block w-full" v-model="form.password" required autocomplete="new-password" />
            </div>
        </div>
            <div class="mt-6">
                <div class="relative">
                ...
                <BreezeInput placeholder="Confirmação de senha" id="password_confirmation" type="password" class="mt-1 block w-full" v-model="form.password_confirmation" required autocomplete="new-password" />
            </div>
        </div>
